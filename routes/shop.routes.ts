...
import { gameParamsSchema, purchaseItemParamsSchema} from "../schemas/game.schema.ts";
...
router.post("/:gameId/buy/:itemId", validate(purchaseItemParamsSchema, 'params'), purchaseShopItem);
